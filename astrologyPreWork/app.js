...
buttonInfo.addEventListener("click", () => {
    ...
    if (day < 0 || month < 0 || day > 31 || month > 12) {
        ...
        if (month === 01 && day >= 20 || month === 02 && day <= 18) {
            ...
            taurus.id = "taurusStyle"
            taurus.className = "animate"
            ...
            gemini.id = "geminiStyle"
            gemini.className = "animate"
            ...
            cancer.id = "cancerStyle"
            cancer.className = "animate"
            ...
            scorpio.id = "scorpioStyle"
            scorpio.className = "animate"
            ...
            sagitarrius.id = "sagittariusStyle"
            sagitarrius.className = "animate"
            ...
            capricorn.id = "capricornStyle"
            capricorn.className = "animate"
